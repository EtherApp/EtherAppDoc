...
Nach dem Start zeigt die App eine Liste aller auf dem Server zur Verfügung stehenden Pads (siehe \autoref{fig:Padliste}).
...
Daher entschieden wir uns, bis zur Implementierung der Threads als \texttt{AysncTask}, vorübergehend Netzwerk auf dem MainThread zu erlauben (siehe \autoref{lst:net}).
\\[1em]
...
Java war uns als Programmiersprache bereits geläufig, die Android-spezifischen Elemente und Eigenschaften mussten wir uns erst erschließen.
...
Der Quellcode der Applikation ist frei auf Github\footnote{https://github.com/EtherApp/EtherApp} verfügbar.

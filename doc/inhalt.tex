...
\begin{table}[h!]
    \begin{center}
      ...
      \begin{tabular}{|l|l|}
          ...
          \hline API Key & Eindeutiger Schlüssel für den Zugriff\\
          \hline
      \end{tabular}
...
Am oberen Rand des Bildschirms sollte eine Tab-Leiste zu sehen sein, beim Anklicken sollte der Inhaltsbereich unten aktualisiert werden.\\

...
\begin{document}
    ...
    \pagestyle{fancy} 
    \rhead{\thepage} \chead{} \lhead{Abschlussbericht} 
    \lfoot{Martin Stoffers} \cfoot{} \rfoot{\today}
    ...
    fmnjksfnsdjkfnsdfnjkdsnfsdjkn\citeque{IEEE802-11}
    %\input{systembeschreibung}
    ...
    \begin{flushleft}% Flattersatz
      \begin{appendix}
        ...
        \nocitelit{*}
        \newpage             
        \label{lit:weitereQuellen}
        \bibliographystylelit{gerunsrt}
